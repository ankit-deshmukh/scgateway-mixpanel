...
public class SCGatewayMixpanel: NSObject{
    
    public static let shared = SCGatewayMixpanel()
    
    open func hello() {
        Mixpanel.initialize(token: "952676d310d87d9665e5d79f88cc8814", trackAutomaticEvents: false)
        print("Initialised Mixpanel")
    }
